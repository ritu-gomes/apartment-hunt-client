            ...
            <div className="row">
                ...
                <div className="col-md-5 p-3">
                    <form className="p-5 pt-0" onSubmit={handleSubmit(onSubmit)}>
                        <input className="form-control py-3 mb-2" type="name" name="name" ref={register({ required: true, pattern: /^[a-zA-Z '.-]*$/ })} placeholder="FULL NAME" />
                        {errors.name && <span>This field is required</span>}
                        <input className="form-control py-3 mb-2" type="number" name="number" ref={register({ required: true, maxLength: 13 })} placeholder="PHONE NO." />
